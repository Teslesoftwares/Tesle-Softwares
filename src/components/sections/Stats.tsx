...
const stats = [
  { value: 50, suffix: '+', label: 'Projects Delivered', desc: 'Across web, mobile, branding, and software' },
  { value: 30, suffix: '+', label: 'Happy Clients', desc: 'From startups to Fortune 500 companies' },
  { value: 5, suffix: '+', label: 'Years Experience', desc: 'Serving clients since 2021' },
  { value: 15, suffix: '+', label: 'Team Members', desc: 'Engineers, designers, and strategists' },
];
...
function StatCard({ value, suffix, label, desc, index }: { value: number; suffix: string; label: string; desc: string; index: number }) {
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm sm:text-base text-white font-medium">{label}</p>
  ...
  return (
    <section ref={ref} className="relative py-24 sm:py-32 overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-b from-accent/[0.02] via-purple/[0.02] to-transparent" />
        <motion.div
