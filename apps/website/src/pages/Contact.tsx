    ...
    <motion.div variants={itemVariants} className="glass rounded-2xl border border-white/[0.06] overflow-hidden hover:border-accent/20 transition-all duration-500 group">
      <div className="relative h-40 sm:h-48 overflow-hidden">
        ...
        <div className="absolute bottom-3 left-4">
          <h3 className="text-base font-semibold text-text">{office.name}</h3>
          {office.featured && (
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-xs font-semibold text-text mb-1">{item.label}</h3>
          ...
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
                ...
                {formTab === 'contact' ? (
                  ...
                  >
                    ...
                    {contactSubmitted ? (
                      ...
                      <button type="submit" className="w-full h-12 text-sm font-medium bg-accent text-black rounded-full hover:shadow-[0_0_25px_rgba(255,107,0,0.3)] transition-all duration-300 inline-flex items-center justify-center gap-2">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <GlassCard className="!p-5">
                <h3 className="text-sm font-semibold text-text mb-4">Quick Contact</h3>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${email.general}`} className="text-sm text-text hover:text-accent transition-colors">{email.general}</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-lg bg-accent/10 border border-accent/20 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${email.sales}`} className="text-sm text-text hover:text-accent transition-colors">{email.sales}</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-lg bg-accent/10 border border-accent/20 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${email.support}`} className="text-sm text-text hover:text-accent transition-colors">{email.support}</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-lg bg-accent/10 border border-accent/20 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${email.careers}`} className="text-sm text-text hover:text-accent transition-colors">{email.careers}</a>
                    </div>
                  </div>
                </div>
              </GlassCard>
              ...
              <GlassCard className="!p-5 !bg-[#25D366]/5 !border-[#25D366]/20">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-text mb-1">Chat on WhatsApp</h3>
                ...
                <div className="space-y-2">
                  {hours.map((h) => (
                    <div key={h.day} className="flex items-center justify-between text-xs">
                      ...
                      <span className={`text-text font-medium ${h.hours === 'Closed' ? 'text-red-400' : ''}`}>{h.hours}</span>
                    </div>
                  ))}
                </div>
              </GlassCard>
      ...
      <section className="relative pb-16 sm:pb-24" id="offices">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="glass rounded-2xl border border-white/[0.06] overflow-hidden">
            <div className="aspect-[21/9] min-h-[250px] bg-gradient-to-br from-accent/[0.03] via-accent/[0.02] to-transparent relative">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 mt-4 px-4 py-2 text-xs font-medium bg-accent text-black rounded-full hover:shadow-[0_0_20px_rgba(255,107,0,0.3)] transition-all"
                  >
            ...
            {[
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-4 text-left text-sm font-medium text-text hover:glass transition-colors"
                >
                  {faq.q}
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <AnimatedSection delay={0.1}>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <a href={`mailto:${email.sales}`} className="px-9 py-4 text-lg font-medium bg-accent text-black rounded-full hover:shadow-[0_0_30px_rgba(255,107,0,0.3)] hover:scale-105 transition-all duration-300 inline-flex items-center gap-2">
                Start a Conversation <ArrowRight className="w-5 h-5" />
              </a>
              <a href={getWhatsAppUrl()} target="_blank" rel="noopener noreferrer" className="px-9 py-4 text-lg font-medium border border-gray-300 text-text rounded-full hover:bg-gray-50 hover:border-gray-400 transition-all duration-300 inline-flex items-center gap-2">
