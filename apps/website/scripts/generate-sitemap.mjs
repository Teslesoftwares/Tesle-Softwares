...
const productSlugs = [
  'enterprise-erp', 'crm-platform', 'human-resources',
  'financial-management', 'project-and-portfolio', 'business-intelligence',
  'customer-support', 'supply-chain', 'payroll-and-compliance',
  'inventory-management', 'team-collaboration', 'platform-and-api',
];
...
const urls = [
  ...
  { loc: '/developers', priority: '0.8', changefreq: 'monthly' },
  ...
  ...productSlugs.map((slug) => ({ loc: `/services/${slug}`, priority: '0.7', changefreq: 'monthly' })),
