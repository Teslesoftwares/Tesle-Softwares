...
const slides: Slide[] = [
  { id: 1, icon: Sparkles, title: 'Neural Intelligence', gradient: 'from-accent via-accent/50 to-purple', color: '#FF6B00' },
  { id: 2, icon: Orbit, title: 'Spatial Computing', gradient: 'from-purple via-purple/50 to-accent', color: '#8B5CF6' },
  { id: 3, icon: Zap, title: 'Real-Time Sync', gradient: 'from-accent via-cyan-400 to-accent/30', color: '#FF6B00' },
  { id: 4, icon: Globe, title: 'Global Network', gradient: 'from-purple/80 via-accent/40 to-purple', color: '#8B5CF6' },
  { id: 5, icon: Cpu, title: 'Quantum Core', gradient: 'from-accent/80 via-purple/60 to-accent/20', color: '#FF6B00' },
