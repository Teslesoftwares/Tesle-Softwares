      ...
      <GlassCard className="h-full !p-0 overflow-hidden">
        ...
        <div className="relative aspect-[4/3] overflow-hidden glass">
          ...
          <div className="absolute top-3 left-3">
            <span className={`px-2.5 py-1 rounded-full text-[10px] font-semibold tracking-wider uppercase bg-gradient-to-r ${categoryColors[project.category] || 'from-accent to-accent-dark'} text-white shadow-lg`}>
              {project.category}
            </span>
          </div>
