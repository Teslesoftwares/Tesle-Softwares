  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-200 mt-1">Welcome to your client portal</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold flex items-center gap-2"><Ticket size={16} className="text-gray-200" /> Recent Tickets</h2>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold flex items-center gap-2"><Bell size={16} className="text-gray-200" /> Notifications</h2>
              ...
              {notifications.map((n: any) => (
                <div key={n.id} className="flex items-start gap-3 py-2 border-b border-gray-800/50 last:border-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-200 truncate">{n.message}</p>
                  </div>
                </div>
              ))}
            </div>
