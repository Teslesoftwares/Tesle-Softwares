...
export default function ProjectDetail() {
  ...
  const catColor = categoryColors[project.category] || 'from-accent to-accent-dark';
            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              <AnimatedSection delay={0.2}>
                <div className="glass rounded-2xl p-6 border border-white/[0.06]">
                  ...
                  <p className="text-text font-medium">{project.client.name}</p>
                  <p className="text-sm text-muted">{project.client.company}</p>
                  {project.client.website && project.client.website !== '#' && (
                    <a
                      href={project.client.website}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-accent text-white text-sm font-semibold hover:bg-accent/90 transition-colors"
                    >
                      Visit Website
                ...
                <AnimatedSection delay={0.25}>
                  <div className="glass rounded-2xl p-6 border border-white/[0.06]">
                    ...
                    <div className="flex items-center gap-3">
                      <div className={`w-9 h-9 rounded-full bg-gradient-to-br ${catColor} flex items-center justify-center text-xs font-bold text-text`}>
                        {project.testimonial.author.charAt(0)}
                      </div>
                      <div>
                        <p className="text-sm font-medium text-text">{project.testimonial.author}</p>
