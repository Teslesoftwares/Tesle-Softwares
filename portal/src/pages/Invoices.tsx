  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-1">Your billing summary</p>
      </div>
            ...
            <div key={inv.id} className="flex items-center justify-between px-5 py-4 border-b border-gray-800/50 last:border-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">{inv.description || 'No description'} · Due {new Date(inv.due_date).toLocaleDateString()}</p>
                </div>
              </div>
