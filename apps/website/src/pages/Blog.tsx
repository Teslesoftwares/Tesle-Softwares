                    ...
                    <article className="glass rounded-2xl overflow-hidden h-full border border-white/[0.06] hover:border-accent/30 transition-all duration-500">
                      <div className="relative aspect-[16/9] overflow-hidden">
                        ...
                        <div className="absolute bottom-3 left-3 right-3">
                          <span className="px-2 py-0.5 rounded-full bg-white/10 backdrop-blur-sm text-[10px] text-text">
                            {article.category}
                          </span>
                        </div>
                      </div>
                      <div className="p-4 sm:p-5">
                        <h3 className="text-base sm:text-lg font-semibold text-text mb-2 group-hover:text-accent transition-colors line-clamp-2">
                          {article.title}
                        </h3>
                    ...
                    <Link to={`/blog/${article.slug}`} className="block h-full group">
                      <article className="glass rounded-2xl overflow-hidden h-full border border-white/[0.06] hover:border-accent/20 transition-all duration-500">
                        <div className="relative aspect-[16/9] overflow-hidden glass">
                          ...
                          <span className="absolute top-3 left-3 px-2 py-0.5 rounded-full bg-white/10 backdrop-blur-sm text-[10px] text-text">
                            {article.category}
                          </span>
                        </div>
                        <div className="p-4 sm:p-5">
              ...
              {hasMore && (
                <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="mt-10 text-center">
                  <button onClick={() => setVisibleCount((c) => c + ITEMS_PER_PAGE)}
                    className="px-6 py-3 text-sm font-medium border border-gray-300 text-text rounded-full hover:bg-gray-50 hover:border-gray-400 transition-all duration-300 inline-flex items-center gap-2"
                  >
                    Load More Articles
            ...
            <div className="glass rounded-3xl p-8 sm:p-12 text-center border border-white/[0.06]">
              ...
              <form onSubmit={(e) => e.preventDefault()} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 h-12 px-5 text-sm bg-white border border-gray-200 rounded-full text-text placeholder:text-muted focus:outline-none focus:border-accent/40 transition-colors"
                  required
                />
                <button type="submit"
                  className="h-12 px-7 text-sm font-medium bg-accent text-black rounded-full hover:shadow-[0_0_25px_rgba(255,107,0,0.3)] transition-all duration-300 flex items-center gap-2 justify-center flex-shrink-0"
                >
                  Subscribe
