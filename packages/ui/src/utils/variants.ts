...
export const variants = {
  fadeIn, fadeInCenter, slideUp, slideDown, slideLeft, slideRight, scaleIn,
  visible, visibleDelayed, stagger, exitScale, exitFade,
};
export const transitions = { spring, springSoft, springSnap };
export const animations = { variants, transitions };
