...
const columns: Column<Career>[] = [
  ...
  { key: 'department', header: 'Department' },
  {
    ...
    render: (item) => (
      <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${typeColors[item.type] || 'bg-gray-800 text-gray-400'}`}>
        {item.type}
      </span>
    ),
  },
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage job openings</p>
        </div>
