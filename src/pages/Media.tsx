                ...
                <motion.button
                  ...
                  className={`flex items-center gap-2.5 flex-shrink-0 px-4 py-2.5 rounded-full border transition-all duration-300 ${
                    isActive
                      ...
                      : 'border-white/[0.10] text-muted hover:text-white hover:border-white/25 bg-white/[0.02]'
                  }`}
                >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <AnimatedSection delay={0.1}>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#cta"
                className="px-9 py-4 text-lg font-medium bg-accent text-black rounded-full hover:shadow-[0_0_30px_rgba(0,229,255,0.3)] hover:scale-105 transition-all duration-300 inline-flex items-center gap-2"
              >
                Start a Project
              </a>
              <a
                href="/portfolio"
                className="px-9 py-4 text-lg font-medium border border-white/20 text-white rounded-full hover:bg-white/5 hover:border-white/40 transition-all duration-300 inline-flex items-center gap-2"
              >
                View Our Portfolio
              </a>
            </div>
