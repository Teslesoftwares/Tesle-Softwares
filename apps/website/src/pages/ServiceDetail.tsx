          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start gap-6 sm:gap-8">
              ...
              <motion.div
                ...
                style={{ boxShadow: `0 0 40px ${service.color.includes('cyan') || service.color.includes('teal') || service.color.includes('emerald') ? 'rgba(255,107,0,0.15)' : 'rgba(139,92,246,0.15)'}` }}
              >
              ...
              <div className="flex-1 min-w-0">
                ...
                >
                  <div>
                    <div className="text-xl sm:text-2xl font-bold text-text">{service.features.length}</div>
                    <div className="text-xs text-muted mt-1">Features</div>
                  </div>
                  <div>
                    <div className="text-xl sm:text-2xl font-bold text-text">{service.benefits.length}</div>
                    <div className="text-xs text-muted mt-1">Benefits</div>
                  </div>
                  <div>
                    <div className="text-xl sm:text-2xl font-bold text-text">{service.process.length}</div>
                    <div className="text-xs text-muted mt-1">Steps</div>
                  </div>
                  <div>
                    <div className="text-xl sm:text-2xl font-bold text-text">{service.technologies.length}</div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <AnimatedSection delay={0.2}>
            ...
            <div className="relative">
              <div className="absolute left-[23px] top-2 bottom-2 w-0.5 bg-gradient-to-b from-accent to-accent-dark hidden sm:block" />
                ...
                {service.faqs.map((faq, i) => (
                  ...
                  >
                    <button
                      ...
                      className="w-full flex items-center justify-between px-6 py-4 text-left text-text font-medium hover:glass transition-colors"
                    >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <AnimatedSection delay={0.1}>
            ...
            <p className="mt-6 text-base sm:text-lg text-muted max-w-2xl mx-auto leading-relaxed">
              Book a personalised demo and see how Tesle {service.title} can transform your operations.
            </p>
