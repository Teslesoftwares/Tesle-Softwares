  ...
  return (
    ...
    >
      ...
      <div className={`relative overflow-hidden ${isComparison ? '' : 'aspect-[4/3]'}`}>
        ...
        {isVideo && (
          <div className="absolute bottom-3 right-3 px-2 py-1 rounded-md bg-black/70 backdrop-blur-sm text-[11px] font-medium text-text/90">
            {videoItem.duration}
          </div>
        )}
      ...
      {/* Info */}
      <div className="p-4">
        <h3 className="text-base font-semibold text-text mb-1 group-hover:text-accent transition-colors">
          {item.title}
        </h3>
