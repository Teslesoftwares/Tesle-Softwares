    ...
    <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
      ...
      <div className="text-center">
        ...
        <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-[0.15em] leading-none flex items-center justify-center gap-1 sm:gap-2">
          {letters.map((letter, i) => (
            <motion.span
              ...
              style={{
                textShadow: '0 0 40px rgba(255,107,0,0.15), 0 0 80px rgba(255,107,0,0.05)',
              }}
            >
              {letter}
            </motion.span>
        ...
        <motion.p
          ...
          initial="hidden"
          animate="visible"
          className="mt-4 sm:mt-5 text-sm sm:text-base md:text-lg text-muted tracking-[0.3em] uppercase"
        >
        ...
        <motion.p
          ...
          initial="hidden"
          animate="visible"
          className="mt-3 text-xs sm:text-sm text-muted/80 tracking-wider"
        >
      ...
      >
        <span className="text-[10px] text-muted/90 tracking-[0.2em] uppercase">Scroll</span>
        <motion.div
          animate={{ y: [0, 6, 0] }}
