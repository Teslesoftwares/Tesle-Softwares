const footerColumns = [
  ...
  },
  {
    title: 'Creative',
    links: [
      { label: 'Graphics & Branding', href: '/services/graphics-and-branding' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Distribution & Promotion', href: '/services/digital-distribution-and-promotion' },
    ],
  },
  {
    title: 'Company',
...
export function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/[0.03] bg-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <a href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white font-semibold text-lg tracking-tight">Tesle</span>
            </a>
            <p className="text-sm text-muted leading-relaxed max-w-xs">
              A full-service digital agency. We build products that matter.
            </p>
            <div className="flex items-center gap-3 mt-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-white/[0.03] border border-white/[0.06] flex items-center justify-center text-muted hover:text-accent hover:border-accent/30 transition-all"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="mt-16 pt-8 border-t border-white/[0.03] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <span className="text-white/[0.06]">|</span>
            <a href="#" className="text-sm text-muted hover:text-white transition-colors">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
